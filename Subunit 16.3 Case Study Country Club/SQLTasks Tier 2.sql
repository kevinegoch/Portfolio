...
SELECT sub.court, CONCAT(sub.firstname,  ' ', sub.surname ) AS full_name
FROM (SELECT Facilities.name AS court,
...
select concat(a.surname, ', ', a.firstname) as members,
    concat(b.surname, ', ', b.firstname) as recommended 
from Members a, Members b
where a.recommended > 0 
    and a.recommended = b.memid order by b.surname;

/* Q12: Find the facilities with their usage by member, but not guests */

select name,
    concat(firstname, ' ', surname) as m_name,
